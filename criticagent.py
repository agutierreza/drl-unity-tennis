...
class CriticAgent():
    ...
    def __init__(self, state_size, action_size, num_agents, learning_rate, weight_decay, tau, random_seed):
        ...
        self.critic_optimizer = optim.Adam(self.critic_local.parameters(), lr=learning_rate, weight_decay=weight_decay)
